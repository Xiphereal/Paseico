...
public class OpeningActivity extends AppCompatActivity {
    ...
    private FirebaseUser currentUser;@Override
    ...
    private void goToMainMenu() { //REDIRECTS THE USER TO DIFFERENTS MAINMENU IF THE USER IS A ROUTER OR AN ORGANIZATION
        ...
        ValueEventListener userEventListener = new ValueEventListener() {@Override
        ...
        ValueEventListener organiEventListener = new ValueEventListener() {@Override
        public void onDataChange(DataSnapshot dataSnapshot) {
            if (dataSnapshot.exists()) {
